<template>
	<view class='conter'>
		...
		<u-navbar :is-back="false" height="60"  title=" " :border-bottom="false"
			...
			<view class="slot-wrap">
				...
				<view class="right" style="position: relative;">
					...
					<image src="../../static/image/1.jpg" @click="$.to('/pages/my/agreement?type=play_rule')" mode="">
					</image>
					<image src="../../static/image/2.jpg" @click="gotocangku" mode=""></image>
					<image src="../../static/image/3.jpg"  @click="$.to('/pages/my/yaoqing')" mode=""></image>
		...
		<view class="goods">
			<v-swiper size="normal" previous-margin="150rpx" :autoplay="false" :list="fGoods" circular mode='none' />
		</view>
		<view class="">
		...
		<view class="my_btn">
			<view class="my_btn_item" @click="aa">
				...
				<!-- <img v-show='flags == true' style='width: 100%;height: 100%;' src="~@/static/image/active-shangpin.jpg" alt="">
				<img v-show='flags == false' style='width: 100%;height: 100%;' src="~@/static/image/white-shangpin.jpg" alt=""> -->
				<!-- 赏品一览 -->
			</view>
		...
		<view class="my_list" v-show='flags == false'>
			...
			<view class='column-small'  v-if='flags == false'>
				...
				<view class='small-box' :style="{'background':cuType=='all'?'linear-gradient(to right, rgba(27, 201, 145, .1) 0%, rgba(0, 0, 0, 1) 50%, rgba(27, 201, 145, .1) 100%)':''}" @click='getRecordList("all")'>
					全部
				</view>
				<view class='small-box' :style="{'background':cuType=='supreme'?'linear-gradient(to right, rgba(27, 201, 145, .1) 0%, rgba(0, 0, 0, 1) 50%, rgba(27, 201, 145, .1) 100%)':''}" @click='getRecordList("supreme")'>
					史诗
				</view>
				<view class='small-box' :style="{'background':cuType=='legend'?'linear-gradient(to right, rgba(27, 201, 145, .1) 0%, rgba(0, 0, 0, 1) 50%, rgba(27, 201, 145, .1) 100%)':''}" @click='getRecordList("legend")'>
					传说
				</view>
				<view class='small-box' :style="{'background':cuType=='rare'?'linear-gradient(to right, rgba(27, 201, 145, .1) 0%, rgba(0, 0, 0, 1) 50%, rgba(27, 201, 145, .1) 100%)':''}" @click='getRecordList("rare")'>
					稀有
				</view>
			</view>
			...
			<view class='detail-content'>
				<view class='detail-box' v-for='(item, index) in recordList'>
					<view class='detail-img1'>	<image class='detail-img1'  :src='item.mhimage'></image></view>
				
			
				<view class='detail-img2' v-if='item.tag=="supreme"'><img class='detail-img2' src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/shisi.png'></img></view>	
				<view class='detail-img2' v-if='item.tag=="legend"'><img class='detail-img2' src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/chuanshuo.png'></img></view>
					<view class='detail-img2' v-if='item.tag=="rare"'><img class='detail-img2' src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/xiyou.png'></img></view>
						<view class='detail-img2' v-if='item.tag=="normal"'><img class='detail-img2' src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/gaoji.png'></img></view>
					
					<view class="detail-box-text1">{{item.mhgoodsname}}</view>
				<view  class='detail-img3'>	<image  class='detail-img3' :src='item.avatar'></image></view>
		...
		<view class="my_list" v-show='flags == true'>
			<view class="my_mythic"  v-for="(item,index) in fGoods">
				<view class='my_list_title'>
					<!-- <image src="../../static/image/kf.png" mode=""></image> -->
				
			
			
			<img v-if='item==fGoods.cs' style='width:92rpx;height:92rpx;'   src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/chuanshuo.png'></img>
				<img v-if='item==fGoods.ss'style='width:92rpx;height:92rpx;'src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/shisi.png'></img>
				<img v-if='item==fGoods.xy' style='width:92rpx;height:92rpx;'src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/xiyou.png'></img>
				<img v-if='item==fGoods.gj' style='width:92rpx;height:92rpx;' src='https://bucket-manghe.oss-cn-beijing.aliyuncs.com/hipinsoft.com1/image/gaoji.png'></img>
				
				<!-- <image v-if='item==fGoods.cs'   src='/static/img/chuanshuo.48efd1c5.png'></image> -->
				
					<view class="my_list_title_text"  v-if='item==fGoods.cs'>
						获取概率	{{ boxInfo.probability_cs }}%
					</view>
					<view class="my_list_title_text"  v-if='item==fGoods.ss'>
						获取概率	{{ boxInfo.probability_ss }}%  
					</view>
					<view class="my_list_title_text"  v-if='item==fGoods.xy'>
						获取概率	{{ boxInfo.probability_xy }}%
					</view>
					<view class="my_list_title_text"  v-if='item==fGoods.gj'>
						获取概率	{{ boxInfo.probability_gj }}%
					</view>
				</view>
				<!-- <view class="my_list_item">
					<view class="my_list_children">
						<v-swiper @details="details" :autoplay="false" :circular="false" :list='fGoods.cs'></v-swiper>
					</view>
				</view> -->
				<view class="my_list_scrll">
					<view class="my_list_scrll_item" :style="{backgroundImage:`url(${bgImages[index]})`}" v-for="(child,sIndex) in item">
			...
			<!-- <view class="my_mythic">
				...
				<view class="my_list_item">
					<view class="my_list_children">
						...
						<v-swiper @details="details" :autoplay="false" :circular="false" :list='fGoods.ss'></v-swiper>
					</view>
			...
			<view class="my_mythic">
				...
				<view class="my_list_item">
					<view class="my_list_children">
						...
						<v-swiper @details="details" :autoplay="false" :circular="false" :list='fGoods.xy'></v-swiper>
					</view>
			...
			<view class="my_mythic">
				...
				<view class="my_list_item">
					<view class="my_list_children">
						<v-swiper @details="details" :autoplay="false" :circular="false" :list='fGoods.gj'></v-swiper>
					</view>
		...
		<view class="btm">
			<view class="haoyangmao" @click="goodsshow = true; getFgoods()">
				<!-- <view class="tit">
					<view>
...
<!-- ttt66 -->
			...
			<view class="goodsbg">
				...
				<scroll-view scroll-with-animation :scroll-into-view='dian' style="height: 800rpx;" scroll-y>
					<view class="goodsList">
						<view class="cs list" id="cs" v-for="(item, idx) in fGoods.cs" :key="item.id"
							@click="details(item.id)">
							<view class="dengbox">
								<image src="../../static/image/chuanshuo.png" class="dengji" mode="widthFix"></image>
							</view>
							<view>
								<image :src="item.image" mode=""></image>
							</view>
						...
						<view class="ss list" id="ss" v-for="(item, idx) in fGoods.ss" :key="item.id"
							@click="details(item.id)">
							<view class="dengbox">
								<image src="../../static/image/shisi.png" class="dengji" mode="widthFix"></image>
							</view>
							<view>
								<image :src="item.image" mode=""></image>
							</view>
						...
						<view class="xy list" id='xy' v-for="(item, idx) in fGoods.xy" :key="item.id"
							@click="details(item.id)">
							<view class="dengbox">
								<image src="../../static/image/xiyou.png" class="dengji" mode="widthFix"></image>
							</view>
							<view>
								<image :src="item.image" mode=""></image>
							</view>
						...
						<view class="gj list" id="gj" v-for="(item, idx) in fGoods.gj" :key="item.id"
							@click="details(item.id)">
							<view class="dengbox">
								<image src="../../static/image/gaoji.png" class="dengji" mode="widthFix"></image>
							</view>
							<view>
								<image :src="item.image" mode=""></image>
							</view>
		...
		<u-popup v-model="infoshow" mode="bottom" height="1000" :safe-area-inset-bottom="true">
			<view class="infobg">
				<u-swiper height="650" :autoplay="false" mode="number" indicator-pos="bottomRight"
					:list="goodsDetails.image">
				</u-swiper>
				<view class="wrap">
					<view class="box">
...
.detail-content {
	...
	.detail-box {
		...
		.detail-img1,.detail-img2,.detail-img3 {
			width: 90rpx;
			height: 90rpx;
			display: block;
